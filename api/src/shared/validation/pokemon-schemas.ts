...
export const CreatePokemonSchema = z.object({
  ...
  life: z
    ...
    .max(255, 'Life must be at most 255')
    .default(50),
  ...
  strength: z
    ...
    .max(255, 'Strength must be at most 255')
    .default(50),
  ...
  defense: z
    ...
    .max(255, 'Defense must be at most 255')
    .default(50),
  ...
  speed: z
    ...
    .max(255, 'Speed must be at most 255')
    .default(50),

  height: z
    .number()
    .min(0, 'Height must be at least 0')
    .max(255, 'Height must be at most 255')
    .default(0),
